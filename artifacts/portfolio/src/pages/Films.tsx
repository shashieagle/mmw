    ...
    <div className="min-h-screen bg-background flex flex-col pt-24">
      ...
      <main className="flex-1 container mx-auto px-6 md:px-12 py-12 md:py-24">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl text-lg md:text-xl font-light mb-12">
            Explore our complete portfolio of AI-generated cinema. From abstract experiments to narrative-driven shorts.
          </p>
        </motion.div>
        ...
        {isLoadingVideos ? (
          ...
          <div className="py-32 text-center border border-white/5 bg-white/5">
            <h3 className="text-2xl text-white mb-4 tracking-tight">No films found</h3>
            <p className="text-gray-500 uppercase tracking-widest text-sm">Check back later or adjust filters</p>
          </div>
        )}
      </main>
